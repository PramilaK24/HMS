      ...
      {!doctor ? <Card><h1 className="text-xl">Doctor not found</h1><p className="mt-2 text-white/60">This profile is unavailable. Choose a doctor from the list.</p></Card> : (
        <Card>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-5">
            <div className="flex size-20 items-center justify-center rounded-full border-2 border-text-highlight bg-[#d8e8de] text-[#6f8678]"><Icon icon="solar:user-rounded-bold" width="52" /></div>
